 ...
 * @author saratuma
 */
public class EliminarFilme extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(request.getParameter("id").trim()!= null){
                ...
                if(new FilmeDao().verifyById(idFilme)){
                    if(new FilmeDao().delete(idFilme)){
                        mensagem="Eliminado com sucesso!! id: "+idFilme;
                    }else
                        mensagem="ERRO: ao eliminar um filme, id: "+idFilme;
                }
                else{
                    mensagem="Erro: id não foi encontrado : "+idFilme;
                }
            }
